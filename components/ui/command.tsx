...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        // cmdk sets data-selected="true"/"false" on EVERY item, so presence
        // variants (data-selected:) highlight all rows and hide keyboard
        // navigation — match the value explicitly.
